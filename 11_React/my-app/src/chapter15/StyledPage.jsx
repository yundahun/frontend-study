...
const Wrapper = styled.div`
  ...
  /* 6. 반응형 디자인
    - 일반 CSS 사용할 때와 똑같이 미디어 쿼리 사용 가능
    - 리액트스럽게 react-responsive 라이브러리
  */
...
// 2. props 사용하기
// 컴포넌트 형태라 prop 사용이 가능(최고 장점 중 하나)
const Button = styled.button`
  ...
  /* 4. 여러 줄의 스타일 구문을 조건부로 설정해야하는 경우 css를 불러와 사용 */
...
function StyledPage() {
  return (
    <Wrapper>
      ...
      {/* $는 스타일 지정만을 위한 prop이 DOM 요소로 렌더링되는 것을 방지하기 위해 붙여 임시 prop으로 전환할 수 있다.  */}
